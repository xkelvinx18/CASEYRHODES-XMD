...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Caseyrhodes~WAQSVIoT#BZePDPm3Lbl-InSNWqq6KnHwFioX0p4Nn1IX1HOEWgA",
// add your Session Id 
PREFIX: process.env.PREFIX || "✅,&",
// add your prifix for bot
BOT_NAME: process.env.BOT_NAME || "nigga",
...
OWNER_NAME: process.env.OWNER_NAME || "希✦",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*©ᴋᴇʟᴠɪɴ 希*",
// add bot owner name    
